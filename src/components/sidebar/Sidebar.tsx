      ...
      <div className="flex flex-col h-full">
        ...
        <div className="flex-1 overflow-auto p-2">
          <nav className="flex flex-col gap-1 text-sm">
            <a
              className="flex items-center gap-3 rounded-lg  px-3 py-2 text-white  hover:text-gray-900 transition-all text-xl"
              href="#"
            >
              <svg
                xmlns="http://www.w3.org/2000/svg"
            ...
            <a
              className="flex items-center gap-3 rounded-lg px-3 py-2 text-white transition-all hover:text-gray-900 text-xl"
              href="#"
            >
              <svg
                xmlns="http://www.w3.org/2000/svg"
            ...
            <a
              className="flex items-center gap-3 rounded-lg px-3 py-2  transition-all hover:text-gray-900  text-xl text-white"
              href="#"
            >
              <svg
                xmlns="http://www.w3.org/2000/svg"
